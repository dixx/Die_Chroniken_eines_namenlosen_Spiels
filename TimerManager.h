...
/*! \class TimerManager TimerManager.h "TimerManager.h"
  ...
  \note Instanzierung: `TimerManager& myTimerManager =
...
public:
    ...
    */
    ...
    /*! \brief Entfernt einen Timer aus der Verwaltung und löscht ihn.
      \note Timer wird nicht gelöscht, wenn er nicht von TimeManager erstellt
            wurde!
    ...
    */
    ...
    /*! \brief Erhöht alle von TimeManager verwalteten Timer um die seit dem
               letzten Tick vergangene Zeit.
...
// Ende class TimerManager

#endif
// Ende Header-Datei TimerManager
