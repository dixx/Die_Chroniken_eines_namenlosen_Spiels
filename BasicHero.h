...
public:
    ...
    /*! \brief Konstruktor. Erstellt ein komplettes Objekt aus der textuellen
               Beschreibung des Helden. Wurde er von einem Child der
               Klasse aufgerufen, muss sich dieses um die Erstellung kümmern.
      \param heroData (\a const \a core::stringc&) textuelle Beschreibung des
             Helden
...
// Ende class BasicHero

#endif
// Ende Header-Datei BasicHero
