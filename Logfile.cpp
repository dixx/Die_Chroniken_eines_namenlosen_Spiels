...
Logfile& Logfile::getInstance( io::IFileSystem* fs, const io::path& filename, const u16 logginglevel )
{
...
Logfile::Logfile( io::IFileSystem* fs, const io::path& filename, const u16 logginglevel )
: filename_(filename),
  fs_(fs),
  logfile_(0),
