...
public:
    ...
    */
    ...
    /*! \brief Erhöht den Timer um bestimmten Wert (in Sekunden).
      \attention Muss nicht aufgerufen werden, wenn der Timer von TimerManager
                 verwaltet wird!
    ...
    */
    ...
    /*! \brief Hat der Timer den Endwert erreicht/überschritten?
      \attention Timer wird bei Erreichen des Endwertes nicht automatisch
                 zurückgesetzt oder angehalten! Dies ist z.B. nützlich um
                 herauszufinden, wie lange der Endwert schon überschritten ist.
      \param -
