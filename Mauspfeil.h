/*! \file Mauspfeil.h
  \brief Klasse (Singleton) stellt ein umfassendes Mauspfeil-Management
         bereit.
*/
...
public:
    ...
    */
    ...
    /*! \brief Zeichnet den Mauszeiger mit dem aktuell gewählten Bild auf den
               Bildschirm.
      \param -
      \return -
    */
...
private:
    ...
    core::dimension2di imageCatalogRaster_;  // Aufteilung der Einzelbilder im
                                            // Imagekatalog
    core::array<core::recti> imageCatalogActualPosition_;  // Liste der
                                                          // Positionen aller
                                                          // Einzelbilder
                                                          // innerhalb des
                                                          // Imagekataloges
    core::array<u32> startImageNumber_;  // Liste der Nummern des Startbildes
                                        // für
                                        // Mauspfeilanimation im Imagekatalog
    core::array<u32> endImageNumber_;  // Liste der Nummern des letzten Bildes
                                      // der Mauspfeilanimation im Imagekatalog
    u32 actualImageNumber_;  // Nummer des aktuellen Bildes der
                            // Mauspfeilanimation
    core::array<u32> sequenceSpeed_;  // Liste der Geschwindigkeiten des
                                     // Einzelbild-Wechsels in Bilder pro
                                     // Sekunde
...
// Ende class Mauspfeil

#endif
// Ende Header-Datei Mauspfeil
