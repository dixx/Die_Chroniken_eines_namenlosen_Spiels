...
Logger::Logger(irr::io::IFileSystem *fileSystem, irr::ITimer *clock, const irr::io::path &fileName,
               const Level globalLogLevel, const bool append)
    : text("LogLevel: "), fileName_(fileName), fileSystem_(fileSystem), clock_(clock), globalLogLevel_(globalLogLevel) {
