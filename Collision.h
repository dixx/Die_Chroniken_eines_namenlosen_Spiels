...
/*! \class Collision Collision.h "Collision.h"
  \brief  Schnittstelle zur Collision Detection.
          Diese Klasse enthält Funktionen für das Erkennen und Behandeln
...
public:
    ...
    scene::ISceneNode* collisionNode;  //!< Zeiger auf den von Kollision
                                       //!  betroffenen Szenenknoten;
    ...
    /*! \brief Ersatz für den Konstruktor.
      ...
      \param sceneManager (\a scene::ISceneManager*) Zeiger auf den aktuellen
             SzenenManager des Entchens
    ...
    */
    ...
    /*! \brief Fügt beliebiges Objekt zur "schnellen" Kollisionserkennung
             (im Sichtradius des Helden) hinzu.
      \param object (\a Basic3DObject*) Objekt
      \return -
    */
    void addObjectToRangedDetection( Basic3DObject* object );

    /*! \brief Entfernt beliebiges Objekt aus "schneller" Kollisionserkennung
             (im Sichtradius des Helden).
      \param object (\a Basic3DObject*) Objekt
      \return -
    */
...
//    bool isMouseIntersectingWithWorld();
    ...
    /*! \brief Abfrage, ob ein Strahl durch irgendeinen Knoten durchgeht.
      ...
      \return `true` wenn ein Knoten getroffen wurde, ansonsten `false`
    */
    bool isRayIntersectingWithWorld(
            const core::line3df& ray, scene::ISceneNode* rootNode );

    /*! \brief Abfrage, ob ein Strahl durch irgendeinen Knoten durchgeht,
             der im Sichtbereich des Helden liegt und begehbar ist.
      \param ray (\a core::line3df&) ein 3D-Strahl
      \return `true` wenn ein Knoten getroffen wurde, ansonsten `false`
    */
...
// Ende class Collision

#endif
// Ende Header-Datei Collision
