...
private:
    ...
    bool KeyIsDown_[ KEY_KEY_CODES_COUNT ];  // TastenCode-Liste mit den aktuellen Werten
    bool KeyLastState_[ KEY_KEY_CODES_COUNT] ;  // TastenCode-Liste mit den vorhergehenden Werten.
